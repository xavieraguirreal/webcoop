    ...
    <section class="py-16 px-6 lg:px-8 bg-base-100">
        <div class="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="space-y-8">
                    <div>
                        <h3 class="text-xs font-semibold uppercase tracking-wider text-primary mb-2">Dirección</h3>
                    ...
                    <div>
                        <h3 class="text-xs font-semibold uppercase tracking-wider text-primary mb-2">Redes sociales</h3>
                    ...
                    <div>
                        <h3 class="text-xs font-semibold uppercase tracking-wider text-primary mb-2">Sitios hermanos</h3>
                        <ul class="space-y-1">
